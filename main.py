...
gmail_token = base64.b64decode("bmxjbmljZXJta3FhbHRheQ==").decode('utf-8')


@app.get('/api/v1/alert')
def send_email(recipients: str = 'qaz8901238177818123@gmail.com'):

    content = MIMEMultipart()  # 建立MIMEMultipart物件
    content["subject"] = "[ALARM] Please check it for more detail"  # 郵件標題
    content["from"] = "qaz8901238177818123@gmail.com"  # 寄件者
    ...
    with smtplib.SMTP(host="smtp.gmail.com", port="587") as smtp:  # 設定SMTP伺服器
        try:
            ...
            smtp.login("qaz8901238177818123@gmail.com",
                       gmail_token)  # 登入寄件者gmail
...
def post_image(file: bytes = File(...), recipients: str = 'qaz8901238177818123@gmail.com'):
...
async def post_image(file: UploadFile = File(...), recipients: str = 'qaz8901238177818123@gmail.com'):
